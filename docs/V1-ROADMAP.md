...
| **M2 v1.0.3** | 2026-08-20 规划完成 | Prompt Lab (baseRules YAML 化 + Eval + A/B) | ⏸ **规划中 ([V1.0.3-PLAN.md](./V1.0.3-PLAN.md))** |
| **M3 v1.0.4** | v1.0.3 后 | LLM Trace 可视化 + Framer Motion 微动效 | ⏸ 规划 ([V1.0.4-PLAN.md](./V1.0.4-PLAN.md)) |
| **M4 v1.0.5** | v1.0.4 后 | 厕所标识剪影小人 SVG + 走路/点头/举手 | ⏸ 规划 ([V1.0.5-PLAN.md](./V1.0.5-PLAN.md)) |
| M5 v1.1 | 商业化启动前 | 用户系统 + 多租户 + 订阅 | ⏳ |
| M6 v1.2 | 第一个企业客户 | D1 安全 P1 全部落地 | ⏳ |
| M7 v2.0 | 商业化稳定 6 个月 | 多模态 + 实时协作 + AI 法官 | ⏳ |
